    ...
    return {
        ...
        "models": {
            "I-JEPA + Linear Probe": {
                ...
                "dataset": "Lung CT Classification  —  Healthy / Lung_Nodule (Kaggle)",
                "accuracy": 0.8914, "auc_roc": 0.9582,
                "precision": 0.9195, "recall": 0.8560, "f1": 0.8866,
                ...
                "val_auc_best_epoch": 0.9619,
                "training_epochs": 100, "probe_epochs": 30,
                "pretrain_loss_final": 0.0212,
            },
        },
        "xai_faithfulness": {
            "Heatmap (Grad-CAM)": {
                "deletion_auc": 0.2249, "deletion_std": 0.1142,
                "method_detail": "Target: encoder.blocks[-1].norm1 (last ViT block)",
            },
            "Boundaries (LIME)": {
                "deletion_auc": 0.2253, "deletion_std": 0.1621,
                "method_detail": "SLIC superpixels + local linear surrogate",
            },
            "Attribution (SHAP)": {
                "deletion_auc": 0.2105, "deletion_std": 0.1605,
                "method_detail": "GradientExplainer, pixel-level attributions",
            },
        },
        "dataset": {
        ...
        "training_config": {
            "ijepa_pretrain": {
                "epochs": 100, "batch_size": 32, "optimizer": "AdamW",
                "lr": 0.001, "weight_decay": 0.04, "warmup_epochs": 10,
                "scheduler": "Cosine annealing", "ema_momentum": 0.996,
                "target_mask_ratio": 0.75, "context_scale": "85–100%",
                "final_pretrain_loss": 0.0212,
            },
            "linear_probe": {
